...
* [Back-end web development](back-end-web-development/README.md)
  ...
  * [Authentication and Authorization](back-end-web-development/authentication-and-session-management/README.md)
    ...
    * [Demo Project: Prelude](back-end-web-development/authentication-and-session-management/jwt-demo-prelude.md)
    * [Demo Project: Project Setup](back-end-web-development/authentication-and-session-management/jwt-demo-project-setup.md)
    * [Demo Project: Mongoose Setup](back-end-web-development/authentication-and-session-management/jwt-demo-mongoose-setup.md)
    * [Demo Project: User Model](back-end-web-development/authentication-and-session-management/jwt-demo-create-user-model.md)
    * [Demo Project: User Signup API](back-end-web-development/authentication-and-session-management/jwt-demo-user-registration.md)
    * [Demo Project: Test Fixtures](back-end-web-development/authentication-and-session-management/jwt-demo-test-fixture.md)
    * [Demo Project: User Login API](back-end-web-development/authentication-and-session-management/jwt-demo-user-login.md)
    * [Demo Project: User Change Password API](back-end-web-development/authentication-and-session-management/jwt-demo-change-password.md)
